...
from app.main.service.proposal_service import save_new_proposal_zone, get_all_proposal_zone, save_new_proposal, get_all_proposal
from ..util.dto import ProposalZoneDto, ProposalDto
from ..service.user_service import get_a_user_by_auth_token

# proposal zone dto
api_proposal_zone = ProposalZoneDto.api
proposal_zone = ProposalZoneDto.proposal_zone

# proposal dto
api_proposal = ProposalDto.api
proposal = ProposalDto.proposal
proposal_post = ProposalDto.proposal_post
